...
<h1 id="logo" style="text-align: center; font-size: 36px; padding-bottom: 20px;">Pair a dish</h1>

				<!-- <section id="header">
							<h1 id="logo"><a href="index.html">Choose Wisely</a></h1>	
                </section>   -->
	
	
	<c:forEach begin="0" end="2" items="${foodSelection}" var="food">
			...
			<ul class="divided">
				<li>
					...
					<article class="box highlight">
						<header>
							<h3>
								<p style="text-align: left; color: white; font-size: 28px; margin: 0;">${food.getFoodName()}</p>
								<p style="text-align: left; color: white;"><i class="fas fa-utensils"></i> $${food.getFoodPrice()} 
								</p>
								<input type="hidden" name="WineID2" value="${food.getFoodName()}">
								<input type="hidden" name="WineID1" value="${pairing2.getWineID1()}">
								<input type="hidden" name="email" value="${email}">
							</h3>
						</header>
						<a href="#" class="image left"><img
							src="${food.getFood_IMG_ID()}" /></a>
						<p style="color: white; font-size: 21px; text-align: justify;">${food.getFoodDescrip()}</p>
	...
	<!-- <br>
	<a href="/profile" class="button icon fa-file">Start Over</a>
	<br>
